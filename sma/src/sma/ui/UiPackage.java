...
public interface UiPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the reference list '{@link sma.ui.UI#getLstViewModels <em>Lst View Models</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>The Contenedor Contactar Cm View Model</em>'.
	 * @see sma.ui.UI#getTheContenedorContactarCmViewModel()
	 * @see #getUI()
	 * @generated
	 */
	EReference getUI_TheContenedorContactarCmViewModel();

	/**
	 * Returns the meta object for the containment reference '{@link sma.ui.UI#getTheContenedorSolicitudVisitaViewModel <em>The Contenedor Solicitud Visita View Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>The Contenedor Solicitud Visita View Model</em>'.
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference UI__THE_CONTENEDOR_CONTACTAR_CM_VIEW_MODEL = eINSTANCE.getUI_TheContenedorContactarCmViewModel();

		/**
		 * The meta object literal for the '<em><b>The Contenedor Solicitud Visita View Model</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
