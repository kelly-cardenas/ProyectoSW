 ...
 * </p>
 * <ul>
 * <li>{@link sma.ui.impl.UIImpl#getTheModelFactory <em>The Model
 * Factory</em>}</li>
 ...
 * <li>{@link sma.ui.impl.UIImpl#getTheContenedorCrudClienteViewModel <em>The
 * Contenedor Crud Cliente View Model</em>}</li>
 * <li>{@link sma.ui.impl.UIImpl#getTheContenedorCRUDCMViewModel <em>The
 * Contenedor CRUDCM View Model</em>}</li>
 * <li>{@link sma.ui.impl.UIImpl#getTheContenedorRegistroVehiculoViewModel
 * <em>The Contenedor Registro Vehiculo View Model</em>}</li>
 * <li>{@link sma.ui.impl.UIImpl#getTheContenedorLoginViewModel <em>The
 * Contenedor Login View Model</em>}</li>
 * <li>{@link sma.ui.impl.UIImpl#getLstViewModels <em>Lst View Models</em>}</li>
 * <li>{@link sma.ui.impl.UIImpl#getTheContenedorContactarCmViewModel <em>The
 * Contenedor Contactar Cm View Model</em>}</li>
 * <li>{@link sma.ui.impl.UIImpl#getTheContenedorSolicitudVisitaViewModel
 * <em>The Contenedor Solicitud Visita View Model</em>}</li>
 * <li>{@link sma.ui.impl.UIImpl#getTheContenedorEscaneoViewModel <em>The
 * Contenedor Escaneo View Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UIImpl extends EObjectImpl implements UI {
	/**
	 * The default value of the '{@link #getIdLogueado() <em>Id Logueado</em>}'
	...
	/**
	 * The cached value of the '{@link #getIdLogueado() <em>Id Logueado</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getIdLogueado()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getTipoLogueado() <em>Tipo Logueado</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getTipoLogueado()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getTipoLogueado() <em>Tipo Logueado</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getTipoLogueado()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getTheDomain() <em>The Domain</em>}'
	...
	/**
	 * The cached value of the '{@link #getTheContenedorCRUDCMViewModel() <em>The
	 * Contenedor CRUDCM View Model</em>}' containment reference. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getTheContenedorRegistroVehiculoViewModel()
	 * <em>The Contenedor Registro Vehiculo View Model</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getTheContenedorLoginViewModel() <em>The
	 * Contenedor Login View Model</em>}' containment reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getLstViewModels() <em>Lst View
	...
	/**
	 * The cached value of the '{@link #getTheContenedorContactarCmViewModel()
	 * <em>The Contenedor Contactar Cm View Model</em>}' containment reference. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getTheContenedorSolicitudVisitaViewModel()
	 * <em>The Contenedor Solicitud Visita View Model</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getTheContenedorEscaneoViewModel() <em>The
	 * Contenedor Escaneo View Model</em>}' containment reference. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public ModelFactory getTheModelFactory() {
		if (eContainerFeatureID() != UiPackage.UI__THE_MODEL_FACTORY)
			return null;
	...
	public void setTheModelFactory(ModelFactory newTheModelFactory) {
		if (newTheModelFactory != eInternalContainer()
				|| (eContainerFeatureID() != UiPackage.UI__THE_MODEL_FACTORY && newTheModelFactory != null)) {
			...
			if (newTheModelFactory != null)
				msgs = ((InternalEObject) newTheModelFactory).eInverseAdd(this, smaPackage.MODEL_FACTORY__THE_UI,
						ModelFactory.class, msgs);
			msgs = basicSetTheModelFactory(newTheModelFactory, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__THE_MODEL_FACTORY, newTheModelFactory,
					newTheModelFactory));
	}
	...
	public void setIdLogueado(String newIdLogueado) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__ID_LOGUEADO, oldIdLogueado,
					idLogueado));
	}
	...
	public void setTipoLogueado(String newTipoLogueado) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__TIPO_LOGUEADO, oldTipoLogueado,
					tipoLogueado));
	}
	...
	public Domain getTheDomain() {
		if (theDomain != null && theDomain.eIsProxy()) {
			...
			if (theDomain != oldTheDomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UiPackage.UI__THE_DOMAIN, oldTheDomain,
							theDomain));
			}
		}
		return theDomain;
	...
	public NotificationChain basicSetTheDomain(Domain newTheDomain, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UiPackage.UI__THE_DOMAIN,
					oldTheDomain, newTheDomain);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTheDomain(Domain newTheDomain) {
		if (newTheDomain != theDomain) {
			NotificationChain msgs = null;
			if (theDomain != null)
				msgs = ((InternalEObject) theDomain).eInverseRemove(this, DomainPackage.DOMAIN__THE_UI, Domain.class,
						msgs);
			if (newTheDomain != null)
				msgs = ((InternalEObject) newTheDomain).eInverseAdd(this, DomainPackage.DOMAIN__THE_UI, Domain.class,
						msgs);
			msgs = basicSetTheDomain(newTheDomain, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__THE_DOMAIN, newTheDomain,
					newTheDomain));
	}
		...
		if (newTheContenedorCrudClienteViewModel != theContenedorCrudClienteViewModel) {
			...
			if (theContenedorCrudClienteViewModel != null)
				msgs = ((InternalEObject) theContenedorCrudClienteViewModel).eInverseRemove(this,
						ContenedorcrudclienteviewmodelPackage.CONTENEDOR_CRUD_CLIENTE_VIEW_MODEL__OWNED_BY_UI,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTheContenedorCRUDCMViewModel(
			ContenedorCRUDCMViewModel newTheContenedorCRUDCMViewModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_CRUDCM_VIEW_MODEL, oldTheContenedorCRUDCMViewModel,
					newTheContenedorCRUDCMViewModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTheContenedorCRUDCMViewModel(ContenedorCRUDCMViewModel newTheContenedorCRUDCMViewModel) {
		if (newTheContenedorCRUDCMViewModel != theContenedorCRUDCMViewModel) {
			...
			if (theContenedorCRUDCMViewModel != null)
				msgs = ((InternalEObject) theContenedorCRUDCMViewModel).eInverseRemove(this,
						ContenedorcrudcmviewmodelPackage.CONTENEDOR_CRUDCM_VIEW_MODEL__OWNED_BY_UI,
						ContenedorCRUDCMViewModel.class, msgs);
			if (newTheContenedorCRUDCMViewModel != null)
				msgs = ((InternalEObject) newTheContenedorCRUDCMViewModel).eInverseAdd(this,
						ContenedorcrudcmviewmodelPackage.CONTENEDOR_CRUDCM_VIEW_MODEL__OWNED_BY_UI,
						ContenedorCRUDCMViewModel.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__THE_CONTENEDOR_CRUDCM_VIEW_MODEL,
					newTheContenedorCRUDCMViewModel, newTheContenedorCRUDCMViewModel));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTheContenedorRegistroVehiculoViewModel(
			ContenedorRegistroVehiculoViewModel newTheContenedorRegistroVehiculoViewModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_REGISTRO_VEHICULO_VIEW_MODEL,
					oldTheContenedorRegistroVehiculoViewModel, newTheContenedorRegistroVehiculoViewModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setTheContenedorRegistroVehiculoViewModel(
			ContenedorRegistroVehiculoViewModel newTheContenedorRegistroVehiculoViewModel) {
		if (newTheContenedorRegistroVehiculoViewModel != theContenedorRegistroVehiculoViewModel) {
			...
			if (theContenedorRegistroVehiculoViewModel != null)
				msgs = ((InternalEObject) theContenedorRegistroVehiculoViewModel).eInverseRemove(this,
						ContenedorregistrovehiculoviewmodelPackage.CONTENEDOR_REGISTRO_VEHICULO_VIEW_MODEL__OWNED_BY_UI,
						ContenedorRegistroVehiculoViewModel.class, msgs);
			if (newTheContenedorRegistroVehiculoViewModel != null)
				msgs = ((InternalEObject) newTheContenedorRegistroVehiculoViewModel).eInverseAdd(this,
						ContenedorregistrovehiculoviewmodelPackage.CONTENEDOR_REGISTRO_VEHICULO_VIEW_MODEL__OWNED_BY_UI,
						ContenedorRegistroVehiculoViewModel.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_REGISTRO_VEHICULO_VIEW_MODEL,
					newTheContenedorRegistroVehiculoViewModel, newTheContenedorRegistroVehiculoViewModel));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTheContenedorLoginViewModel(
			ContenedorLoginViewModel newTheContenedorLoginViewModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_LOGIN_VIEW_MODEL, oldTheContenedorLoginViewModel,
					newTheContenedorLoginViewModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTheContenedorLoginViewModel(ContenedorLoginViewModel newTheContenedorLoginViewModel) {
		if (newTheContenedorLoginViewModel != theContenedorLoginViewModel) {
			...
			if (theContenedorLoginViewModel != null)
				msgs = ((InternalEObject) theContenedorLoginViewModel).eInverseRemove(this,
						ContenedorloginviewmodelPackage.CONTENEDOR_LOGIN_VIEW_MODEL__OWNED_BY_UI,
						ContenedorLoginViewModel.class, msgs);
			if (newTheContenedorLoginViewModel != null)
				msgs = ((InternalEObject) newTheContenedorLoginViewModel).eInverseAdd(this,
						ContenedorloginviewmodelPackage.CONTENEDOR_LOGIN_VIEW_MODEL__OWNED_BY_UI,
						ContenedorLoginViewModel.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__THE_CONTENEDOR_LOGIN_VIEW_MODEL,
					newTheContenedorLoginViewModel, newTheContenedorLoginViewModel));
	}
	...
	public EList<ViewModel> getLstViewModels() {
		if (lstViewModels == null) {
			lstViewModels = new EObjectWithInverseResolvingEList<ViewModel>(ViewModel.class, this,
					UiPackage.UI__LST_VIEW_MODELS, ViewmodelsPackage.VIEW_MODEL__THE_UI);
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTheContenedorContactarCmViewModel(
			ContenedorContactarCmViewModel newTheContenedorContactarCmViewModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_CONTACTAR_CM_VIEW_MODEL, oldTheContenedorContactarCmViewModel,
					newTheContenedorContactarCmViewModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setTheContenedorContactarCmViewModel(
			ContenedorContactarCmViewModel newTheContenedorContactarCmViewModel) {
		if (newTheContenedorContactarCmViewModel != theContenedorContactarCmViewModel) {
			NotificationChain msgs = null;
			if (theContenedorContactarCmViewModel != null)
				msgs = ((InternalEObject) theContenedorContactarCmViewModel).eInverseRemove(this,
						ContenedorcontactarcmviewmodelPackage.CONTENEDOR_CONTACTAR_CM_VIEW_MODEL__OWNED_BY_UI,
						ContenedorContactarCmViewModel.class, msgs);
			if (newTheContenedorContactarCmViewModel != null)
				msgs = ((InternalEObject) newTheContenedorContactarCmViewModel).eInverseAdd(this,
						ContenedorcontactarcmviewmodelPackage.CONTENEDOR_CONTACTAR_CM_VIEW_MODEL__OWNED_BY_UI,
						ContenedorContactarCmViewModel.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__THE_CONTENEDOR_CONTACTAR_CM_VIEW_MODEL,
					newTheContenedorContactarCmViewModel, newTheContenedorContactarCmViewModel));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTheContenedorSolicitudVisitaViewModel(
			ContenedorSolicitudVisitaViewModel newTheContenedorSolicitudVisitaViewModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_SOLICITUD_VISITA_VIEW_MODEL, oldTheContenedorSolicitudVisitaViewModel,
					newTheContenedorSolicitudVisitaViewModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setTheContenedorSolicitudVisitaViewModel(
			ContenedorSolicitudVisitaViewModel newTheContenedorSolicitudVisitaViewModel) {
		if (newTheContenedorSolicitudVisitaViewModel != theContenedorSolicitudVisitaViewModel) {
			...
			if (theContenedorSolicitudVisitaViewModel != null)
				msgs = ((InternalEObject) theContenedorSolicitudVisitaViewModel).eInverseRemove(this,
						ContenedorsolicitudvisitaviewmodelPackage.CONTENEDOR_SOLICITUD_VISITA_VIEW_MODEL__OWNED_BY_UI,
						ContenedorSolicitudVisitaViewModel.class, msgs);
			if (newTheContenedorSolicitudVisitaViewModel != null)
				msgs = ((InternalEObject) newTheContenedorSolicitudVisitaViewModel).eInverseAdd(this,
						ContenedorsolicitudvisitaviewmodelPackage.CONTENEDOR_SOLICITUD_VISITA_VIEW_MODEL__OWNED_BY_UI,
						ContenedorSolicitudVisitaViewModel.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_SOLICITUD_VISITA_VIEW_MODEL, newTheContenedorSolicitudVisitaViewModel,
					newTheContenedorSolicitudVisitaViewModel));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTheContenedorEscaneoViewModel(
			ContenedorEscaneoViewModel newTheContenedorEscaneoViewModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UiPackage.UI__THE_CONTENEDOR_ESCANEO_VIEW_MODEL, oldTheContenedorEscaneoViewModel,
					newTheContenedorEscaneoViewModel);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTheContenedorEscaneoViewModel(ContenedorEscaneoViewModel newTheContenedorEscaneoViewModel) {
		if (newTheContenedorEscaneoViewModel != theContenedorEscaneoViewModel) {
			...
			if (theContenedorEscaneoViewModel != null)
				msgs = ((InternalEObject) theContenedorEscaneoViewModel).eInverseRemove(this,
						ContenedorescaneoviewmodelPackage.CONTENEDOR_ESCANEO_VIEW_MODEL__OWNED_BY_UI,
						ContenedorEscaneoViewModel.class, msgs);
			if (newTheContenedorEscaneoViewModel != null)
				msgs = ((InternalEObject) newTheContenedorEscaneoViewModel).eInverseAdd(this,
						ContenedorescaneoviewmodelPackage.CONTENEDOR_ESCANEO_VIEW_MODEL__OWNED_BY_UI,
						ContenedorEscaneoViewModel.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.UI__THE_CONTENEDOR_ESCANEO_VIEW_MODEL,
					newTheContenedorEscaneoViewModel, newTheContenedorEscaneoViewModel));
	}
	 ...
	 * @generated
	 */
	public void escanearVehiculo(final ContenedorEscaneoViewModel formulario) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case UiPackage.UI__THE_CONTENEDOR_CRUDCM_VIEW_MODEL:
			if (theContenedorCRUDCMViewModel != null)
				msgs = ((InternalEObject) theContenedorCRUDCMViewModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UiPackage.UI__THE_CONTENEDOR_CRUDCM_VIEW_MODEL, null, msgs);
		...
		case UiPackage.UI__THE_CONTENEDOR_REGISTRO_VEHICULO_VIEW_MODEL:
			if (theContenedorRegistroVehiculoViewModel != null)
				msgs = ((InternalEObject) theContenedorRegistroVehiculoViewModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UiPackage.UI__THE_CONTENEDOR_REGISTRO_VEHICULO_VIEW_MODEL, null, msgs);
		...
		case UiPackage.UI__THE_CONTENEDOR_LOGIN_VIEW_MODEL:
			if (theContenedorLoginViewModel != null)
				msgs = ((InternalEObject) theContenedorLoginViewModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UiPackage.UI__THE_CONTENEDOR_LOGIN_VIEW_MODEL, null, msgs);
		...
		case UiPackage.UI__THE_CONTENEDOR_CONTACTAR_CM_VIEW_MODEL:
			if (theContenedorContactarCmViewModel != null)
				msgs = ((InternalEObject) theContenedorContactarCmViewModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UiPackage.UI__THE_CONTENEDOR_CONTACTAR_CM_VIEW_MODEL, null, msgs);
		...
		case UiPackage.UI__THE_CONTENEDOR_SOLICITUD_VISITA_VIEW_MODEL:
			if (theContenedorSolicitudVisitaViewModel != null)
				msgs = ((InternalEObject) theContenedorSolicitudVisitaViewModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UiPackage.UI__THE_CONTENEDOR_SOLICITUD_VISITA_VIEW_MODEL, null, msgs);
		...
		case UiPackage.UI__THE_CONTENEDOR_ESCANEO_VIEW_MODEL:
			if (theContenedorEscaneoViewModel != null)
				msgs = ((InternalEObject) theContenedorEscaneoViewModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UiPackage.UI__THE_CONTENEDOR_ESCANEO_VIEW_MODEL, null, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case UiPackage.UI__THE_MODEL_FACTORY:
			return eInternalContainer().eInverseRemove(this, smaPackage.MODEL_FACTORY__THE_UI, ModelFactory.class,
					msgs);
		}
